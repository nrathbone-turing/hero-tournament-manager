    ...
    <Container maxWidth={false} sx={{ mt: 4, px: 2 }}>
      ...
      <Grid container sx={{ alignItems: "stretch", gap: 2, flexWrap: { xs: "wrap", md: "nowrap" } }}>
        ...
        <Grid item xs={12} md={3} sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
          <Paper sx={{ flex: 1, p: 2, height: 400, display: "flex", flexDirection: "column" }}>
          ...
          {/* Remove Entrant */}
          <Paper sx={{ flex: 1, p: 2, height: 150, display: "flex", flexDirection: "column" }}>
            <Typography variant="h6" gutterBottom>
              Remove Entrant
            </Typography>
            <Box component="form" onSubmit={handleRemoveEntrant} sx={{ display: "flex", gap: 1 }}>
              <TextField
                label="Entrant ID"
                value={removeId}
